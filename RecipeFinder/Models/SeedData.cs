                    ...
                    DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                context.Recipe.AddRange(
                    new Recipe
                    {
                        ...
                        IngredientsWithAmount = "zucchini (chopped) - 1/2 cup, bell pepper (chopped) - 1/4 cup, celery (chopped) - 1/4 cup, broccoli (chopped) - 1/4 cup, chicken breast (cooked and chopped) - 1, cream of mushroom - 2 cans, black pepper - 1/4 teaspoon",
